...
<div> <button class="column" style="border-bottom:0px; border-top: 5px solid #FF7A00; " ><h1>login<h1></button></div>

<div> <button class="column" style="background-color:#bbb;"><h1>Register<h1></button></div>
